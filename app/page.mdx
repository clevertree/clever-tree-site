...
<div className="content columns">
      <section>
        ...
        <div className="experience">
          <ClientImage src={ProfilePicture} className="profile-picture" alt="Profile"/>
        ...
        <section>
          ...
          <div className="experience project">
            <a className="logo" href="https://audiosource.io" {...remoteAttr}>
              <ClientImage src={ASLogo} alt="Audio Source Logo" />
            </a>
          ...
          <div className="experience project">
            <a className="logo" href="https://ffga.me" {...remoteAttr}>
              <ClientImage src={FFLogo} alt="Forgotten Future Logo" />
            </a>
          ...
          <div className="experience project">
            <a className="logo" href="https://paradigmthreat.net/history/timeline" {...remoteAttr}>
              <ClientImage src={PTLogo} alt="Paradigm Threat Logo" />
            </a>
          ...
          <div className="experience project">
            <a className="logo" href="https://github.com/clevertree/relay" {...remoteAttr}>
              <ClientImage src={RSNLogo} alt="Relay Logo" />
            </a>
